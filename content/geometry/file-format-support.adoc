...
This setup differs from how coordinate systems are defined in ASAM OpenMATERIAL, see <<general.html#_coordinate_systems Coordinate Systems>>.
...
see <general.html#_coordinate_systems Coordinate Systems>